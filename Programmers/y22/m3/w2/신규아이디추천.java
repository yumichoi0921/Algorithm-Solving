...
//        System.out.println("0: " + Arrays.toString(id.toArray()));
...
//        System.out.println("1: " + Arrays.toString(id.toArray()));
...
//        System.out.println("2: " + Arrays.toString(id.toArray()));
...
//        System.out.println("3: " + Arrays.toString(id.toArray()));
        // 4단계 new_id에서 마침표(.)가 처음이나 끝에 위치한다면 제거합니다.
        if (!id.isEmpty() && id.get(0) == '.') id.remove(0);
        if (!id.isEmpty() && id.get(id.size() - 1) == '.') id.remove(id.size() - 1);
//        System.out.println("4: " + Arrays.toString(id.toArray()));
        // 5단계 new_id가 빈 문자열이라면, new_id에 "a"를 대입합니다.
        if (id.isEmpty()) id.add('a');
//        System.out.println("5: " + Arrays.toString(id.toArray()));
...
//        System.out.println("6: " + Arrays.toString(id.toArray()));
        // 7단계 new_id의 길이가 2자 이하라면, new_id의 마지막 문자를 new_id의 길이가 3이 될 때까지 반복해서 끝에 붙입니다.
        if (id.size() <= 2) {
            while (id.size() < 3) id.add(id.get(id.size() - 1));
        }
//        System.out.println("7: " + Arrays.toString(id.toArray()));
